...
static nrf_pwm_values_common_t red_values[] = {
...
static nrf_pwm_values_common_t green_values[] = {
    6, 6, 6, 6, 6, 6, 6, 6,
    14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,
    100, 100
 };

 static nrf_pwm_values_common_t blue_values[] = {
    14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,
    6, 6, 6, 6, 6, 6, 6, 6,
    100, 100
 };
...
static void pwm_start(uint32_t num_leds) {
...
void power_leds(uint32_t num_leds) {
	pwm_init();
	pwm_start(num_leds);
}
